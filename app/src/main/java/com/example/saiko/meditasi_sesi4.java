...
public class meditasi_sesi4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meditasi_sesi4);
        ...
        mp = MediaPlayer.create(this, R.raw.malamhari_compress);
        mp.setLooping(true);
        mp.seekTo(0);
    ...
    public void prevBtnClick3(View view) {
        mp.stop();
        Intent intent = new Intent(meditasi_sesi4.this, meditasi_sesi3.class);
        startActivity(intent);
    }

    public void backBtn4(View view) {
        mp.stop();
        Intent intent = new Intent(meditasi_sesi4.this, SesiMeditasiActivity.class);
        startActivity(intent);
    }

    public void nextBtnClick4(View view) {
        mp.stop();
        Intent intent = new Intent(meditasi_sesi4.this, meditasi_sesi5.class);
        startActivity(intent);
    }
}

...
public class meditasi_sesi5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meditasi_sesi5);
        ...
        mp = MediaPlayer.create(this, R.raw.pantaicamar_compress);
        mp.setLooping(true);
        mp.seekTo(0);
    ...
    public void prevBtnClick4(View view) {
        mp.stop();
        Intent intent = new Intent(meditasi_sesi5.this, meditasi_sesi4.class);
        startActivity(intent);
    }

    public void backBtn5(View view) {
        mp.stop();
        Intent intent = new Intent(meditasi_sesi5.this, SesiMeditasiActivity.class);
        startActivity(intent);
    }

    public void nextBtnClick5(View view) {
        mp.stop();
        Intent intent = new Intent(meditasi_sesi5.this, meditasi_sesi1.class);
        startActivity(intent);
    }
}

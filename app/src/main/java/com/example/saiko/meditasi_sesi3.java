...
public class meditasi_sesi3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meditasi_sesi3);
        ...
        mp = MediaPlayer.create(this, R.raw.airmengalir_compress);
        mp.setLooping(true);
        mp.seekTo(0);
    ...
    public void prevBtnClick2(View view) {
        mp.stop();
        Intent intent = new Intent(meditasi_sesi3.this, meditasi_sesi2.class);
        startActivity(intent);
    }

    public void backBtn3(View view) {
        mp.stop();
        Intent intent = new Intent(meditasi_sesi3.this, SesiMeditasiActivity.class);
        startActivity(intent);
    }

    public void nextBtnClick3(View view) {
        mp.stop();
        Intent intent = new Intent(meditasi_sesi3.this, meditasi_sesi4.class);
        startActivity(intent);
    }
}
